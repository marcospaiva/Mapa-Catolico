<div class="grid_7 steps">
	...
	<form action="{$urlbase}admin/paroquiainserir" method="post" name="form" id="form" enctype='multipart/form-data' class="step-1">
		<fieldset id="" class="">          
      		<legend>Nomeclatura e localização</legend>
                ...
                <input type="hidden" name="tipo" id="tipo" value="{$tipo}">
                        ...
                        {if $tipo eq 2}
                            ...
                            <input type="text" name="nome" id="nome" value="{$nome}" title="Digite o nome da Capela"/>
                        {/if}
                        {if $tipo eq 1}
		...
		<a href="">voltar uma etapa</a><input type="submit" name="" value="Finalizar Cadastro"/>
