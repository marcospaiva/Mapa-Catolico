...
<ul>
	...
	<li><a href="javascript:void()" title="Anterior" onclick="listaProximos('{$urlbase}',{$page->previous},{$latitude},{$longitude})"> < </a></li>
	{/if}
	<li>
	...
	{if $page->next}		
	<li><a href="javascript:void()" title="Proximo" onclick="listaProximos('{$urlbase}',{$page->next},{$latitude},{$longitude})"> > </a></li>
