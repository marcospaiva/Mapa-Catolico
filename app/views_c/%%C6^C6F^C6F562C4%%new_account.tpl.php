<?php /* Smarty version 2.6.22, created on 2009-12-16 15:39:13
         compiled from new_account.tpl */ ?>
<div id="new_account" class="container_12 clearfix">
	<form action="" method="post">
			<fieldset>
				<legend>Digite os dados abaixo corretamente</legend>
		...
		<input type="button" value="Crie a minha conta">
	</form>
</div>