...
class IndexController extends Zend_Controller_Action {
    ...
    public function entrarAction() {
        ...
        switch ($autenticado->getCode()) {
            ...
            case Zend_Auth_Result::SUCCESS:
                ...
                } elseif ($dados->us_id == 2) {
                    $this->_redirect("relatorio");
                }
                else
    ...
    public function listaproximosxmlAction() {


        $p = new Paroquias();

        $latitude = $this->_request->getParam('lat');
        $longitude = $this->_request->getParam('long');

        $result = $p->ListarProximas($latitude, $longitude);
